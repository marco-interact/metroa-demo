#!/bin/bash
################################################################################
# METROA POD - Automated Setup Script for New Pod
# Pod: 8pexe48luksdw3 (metroa_worker_gpu)
...
POD_NAME="metroa_worker_gpu"
SSH_HOST="203.57.40.132"
SSH_PORT="10164"
PUBLIC_URL="https://${POD_ID}-8888.proxy.runpod.net"
GITHUB_REPO="https://github.com/marco-interact/metroa-demo.git"
VOLUME_NAME="metroa-volume"
VOLUME_ID="mvmh2mg1pt"

echo "=================================================="
echo "🚀 METROA POD - Automated Setup"
echo "=================================================="
echo ""
...
BUILD_JOBS=$(( BUILD_JOBS > 1 ? BUILD_JOBS : 1 ))
ninja -j$BUILD_JOBS
ninja install
ldconfig
...
echo "   • Restart:      bash /workspace/metroa-demo/setup-pod-8pexe48luksdw3.sh"
echo ""
echo "📋 Test Backend:"
...
echo ""
echo "   Then deploy:"
echo "   cd /Users/marco.aurelio/Desktop/metroa-demo"
